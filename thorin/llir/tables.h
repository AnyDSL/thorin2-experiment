#ifndef THORIN_LLIR_TABLES_H
#define THORIN_LLIR_TABLES_H
...
template<> constexpr auto Num<llir::FCmp> = 0_s THORIN_F_CMP(CODE);
template<> constexpr auto Num<llir::Cast> = 0_s THORIN_CAST (CODE);
#undef CODE
